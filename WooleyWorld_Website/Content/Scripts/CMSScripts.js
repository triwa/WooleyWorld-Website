...
function OpenAnimationPanel( mode, animation ) {
    if ( mode === "new" ) {
        ...
        document.querySelector( "#animationPanel form .foot img" ).style.display = "none";
    }
    else {
        ...
        document.querySelector( "#animationPanel form .foot img" ).style.display = "block";
    ...
    reader.onload = function () {
        ...
        image.onload = function () {
            ...
            if ( image.width > 300 || image.height > 300 ) {
                ...
                document.querySelector( "#animationForm button" ).disabled = true;
            }
            else {
                document.querySelector( "#AnimationError" ).innerHTML = "";
                animationForm.thumbnail.previousElementSibling.removeAttribute( "style" );
                document.querySelector( "#animationForm button" ).disabled = false;
            }
        };
    };
...
function OpenArtworkPanel( mode, type, artwork ) {
    if ( mode === "new" ) {
        ...
        document.querySelector( "#artworkPanel form .foot img" ).style.display = "none";
    }
    else {
        artworkForm.onsubmit = function () { PutArtwork(); return false; };
        document.querySelector( "#artworkPanel .panelTitle" ).innerHTML = "Edit " + type;
        document.querySelector( "#artworkPanel form .foot img" ).style.display = "block";
